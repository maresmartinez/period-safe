 ...
 * @param {string}      props.dateStr       - Pre-computed YYYY-MM-DD string
 * @param {boolean}     props.isCurrentMonth
 * @param {boolean}     props.isToday
 * @param {'start'|'mid'|'end'|'single'|null} props.periodState - null = not a period day
 * @param {boolean}     props.isPredicted
 * @param {boolean}     props.isFocused     - Whether this cell holds keyboard focus
